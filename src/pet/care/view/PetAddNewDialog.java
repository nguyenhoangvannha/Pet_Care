 ...
 * @author nguye
 */
public class PetAddNewDialog extends javax.swing.JDialog {

    private int numPet = 1;
    private int remainPets = 1;
    private int stt = 1;
     ...
     */
    public PetAddNewDialog(CustomerAddDialog customerAddDialog, int numPet, ArrayList<PetModel> pets) {
        this.customerAddDialog = customerAddDialog;
        this.numPet = numPet;
        remainPets = numPet;
        this.pets = pets;
        ...
        initComponents();
        this.setModal(true);
        customerAddDialog.setVisible(false);
        changeGUI();
    }
    ...
    private void initComponents() {
        ...
        lblPetCountLayout.setHorizontalGroup(
            ...
            .addGroup(lblPetCountLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPetCount, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        PetModel pet = new PetModel("001", txtPetName.getText(), null, Integer.parseInt(txtPetSex.getText())
                    , Integer.parseInt(txtPetAge.getText()), txtPetStatus.getText());
        if(stt == numPet){
            pets.add(pet);
            this.dispose();
