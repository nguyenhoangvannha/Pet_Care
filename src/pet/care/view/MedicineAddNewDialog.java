 ...
 * @author nguye
 */
public class MedicineAddNewDialog extends javax.swing.JDialog {
    private Connection connection;
    private MedicineManagerForm staffManagerForm;
    private MedicineModel medicineModel = new MedicineModel();
    /**
     * Creates new form PetDetailDialog2
     */
    public MedicineAddNewDialog(MedicineManagerForm staffManagerForm,Connection connection) {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String result = MyMSSQLControl.addMedicine(connection, medicineModel);
